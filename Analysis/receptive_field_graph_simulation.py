...
title = 'simulation_regresion_h2' + quality + stimuli_type_dense
save_filename = directory + title + formating
figure = plt.gcf() # get current figure
...
directory = './figures/'
formating='.pdf'
title = 'simulation_regresion_h1' + quality + stimuli_type_sparse
save_filename = directory + title + formating 
 
plot_mutliplot_bilinear(closest_square_to_kernel, h1_sparse, colorbar=colorbar, symmetric=symmetric)
figure = plt.gcf() # get current figure
...
plot_mutliplot_bilinear(closest_square_to_kernel, h2_sparse, colorbar=colorbar, symmetric=symmetric)
title = 'simulation_regresion_h2' + quality + stimuli_type_sparse
save_filename = directory + title + formating
figure = plt.gcf() # get current figure
